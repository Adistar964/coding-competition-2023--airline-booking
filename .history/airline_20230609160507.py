...
def main(user,loc):
    ...
    trip_type = IntVar()
    trip_type.set(0)
    Radiobutton(f, text="One-way",value=1,selectcolor="blue",bg="white",variable=trip_type).pack()
    Radiobutton(f, text="Round-way",value=2,selectcolor="blue",bg="white",variable=trip_type).pack()
