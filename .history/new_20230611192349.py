...
def main(user):
    ...
    Label(f, text="From",font=font.Font(size=13)).grid(row=0,column=0)
    Label(f, text="To",font=font.Font(size=13)).grid(row=0,column=1)
    Label(f, text="Departure",font=font.Font(size=13)).grid(row=0,column=2)
    Label(f, text="Arrival(optional)",font=font.Font(size=13)).grid(row=0,column=3)
