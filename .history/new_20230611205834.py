...
def main(user):
    ...
    f = Frame(r,pady=20,bg="sky blue",highlightbackground="black",highlightthickness=3,padx=r.winfo_screenwidth()-1100)
    c.create_window((r.winfo_screenwidth()/2)-1000,100,window=f,anchor="nw")

    Label(f,bg="sky blue", text="From",font=font.Font(size=13),padx=15).grid(row=0,column=0)
    Label(f,bg="sky blue", text="To",font=font.Font(size=13),padx=15).grid(row=0,column=1)
    Label(f,bg="sky blue", text="Departure",font=font.Font(size=13),padx=15).grid(row=0,column=2)
    Label(f,bg="sky blue", text="Arrival(optional)",font=font.Font(size=13),padx=15).grid(row=0,column=3)
    Label(f,bg="sky blue", text="Airways",font=font.Font(size=13),padx=15).grid(row=0,column=4)
    ...
    Label(f,bg="sky blue", text="Adults(12)",font=font.Font(size=13),padx=15,pady=10).grid(row=2,column=0)
    Label(f,bg="sky blue", text="Children(0-12)",font=font.Font(size=13),padx=15,pady=20).grid(row=2,column=1)
    Label(f,bg="sky blue", text="Cabin Class",font=font.Font(size=13),padx=15,pady=20).grid(row=2,column=2)
    Label(f,bg="sky blue", text="Trip Type",font=font.Font(size=13),padx=15,pady=20).grid(row=2,column=3)
