...
def main(user,loc):
    ...
    trip_type = StringVar()
    Radiobutton(f, text="One-way",selectcolor=="blue",bg="white",variable=trip_type).pack()
    Radiobutton(f, text="Round-way",selectcolor=="blue",bg="white",variable=trip_type).pack()
