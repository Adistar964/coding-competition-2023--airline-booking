...
def main(user,loc):
    ...
    trip_type = IntVar()
    Radiobutton(f, text="One-way",selectcolor="blue",bg="white",variable=trip_type,value=1).pack()
    Radiobutton(f, text="Round-way",selectcolor="blue",bg="white",variable=trip_type,value=2).pack()
