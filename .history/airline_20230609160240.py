...
def main(user,loc):
    ...
    Label(f,text="Trip type:",font=("Arial",13)).pack()
    trip_type = StringVar()
    Radiobutton(f, text="One-way",activeforeground="blue",disabledforeground="white",bg="white",variable=trip_type).pack()
    Radiobutton(f, text="Round-way",activeforeground="blue",disabledforeground="white",bg="white",variable=trip_type).pack()
