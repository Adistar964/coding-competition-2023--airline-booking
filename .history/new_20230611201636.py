...
def main(user):
    ...
    def conf_book():
        ...
        time = f"{random.randrange(1,23)}:{random.randrange(1,61)}"
        ...
        Label(top, font=font.Font(weight="bold",size=15),text="Please enter your credit card number to confirm booking:").pack(pady=5)
        Entry(top,font=font.Font(size=13)).pack(pady=5)
        Button(top,font=font.Font(size=13),bg="green",fg="white", command=book).pack(pady=10)
        top.mainloop()
