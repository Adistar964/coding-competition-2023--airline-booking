...
def main(user,loc):
    ...
    trip_type = IntVar()
    Radiobutton(f, bg="white",font=("Arial",13),selectcolor="red",text="One-way",variable=trip_type,value=1).pack()
    Radiobutton(f, bg="white",font=("Arial",13),selectcolor="red",text="Round-way",variable=trip_type,value=2).pack()
