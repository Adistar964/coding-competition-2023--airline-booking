...
def main(user):
    ...
    Button(f, text="Show Flight",bg="green",fg="white",font=font.Font(size=13),padx=15).grid(row=3,column=4)

    l = Button(text="Show Flight",bg="green",fg="white",font=font.Font(size=13),padx=15)

    c.create_window(600,(r.winfo_screenwidth()/2)-1000,window=l)
