...
def main(user,loc):
    ...
    trip_type = IntVar()
    Radiobutton(f, bg="white",font=("Arial",13),selectcolor="blue",text="One-way",variable=trip_type,value=1).pack()
    Radiobutton(f, bg="white",font=("Arial",13),selectcolor="blue",text="Round-way",variable=trip_type,value=2).pack()
