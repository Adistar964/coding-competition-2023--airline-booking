...
def main(user,loc):
    ...
    img = PhotoImage(file="bg.png",width=r.winfo_screenwidth(),height=r.winfo_screenheight())
    # w = r.winfo_screenwidth()/1000
    # h = r.winfo_screenheight()/700
    # img.zoom(w,h)
    ...
    Button(r, text="Show Bookings").pack(pady=15)
