...
def main(user):
    ...
    Label(f,bg="white", text="From",font=font.Font(size=13),padx=15).grid(row=0,column=0)
    Label(f,bg="white", text="To",font=font.Font(size=13),padx=15).grid(row=0,column=1)
    Label(f,bg="white", text="Departure",font=font.Font(size=13),padx=15).grid(row=0,column=2)
    Label(f,bg="white", text="Arrival(optional)",font=font.Font(size=13),padx=15).grid(row=0,column=3)
    Label(f,bg="white", text="Airways",font=font.Font(size=13),padx=15).grid(row=0,column=4)
    ...
    Label(f,bg="white", text="Adults(12)",font=font.Font(size=13),padx=15,pady=20).grid(row=2,column=0)
    Label(f,bg="white", text="Children(0-12)",font=font.Font(size=13),padx=15,pady=20).grid(row=2,column=1)
    Label(f,bg="white", text="Cabin Class",font=font.Font(size=13),padx=15,pady=20).grid(row=2,column=2)
    Label(f,bg="white", text="Trip Type",font=font.Font(size=13),padx=15,pady=20).grid(row=2,column=3)
