...
def main(user,loc):
    ...
    def show_book():
        t = Toplevel(r)
        t.geometry("500x500")
        Label(t, text="Your Bookings:",font=font.Font(size=15,underline=True,weight="bold")).pack(pady=12)
        check = df.name
        if user in check:
            pass
        else:
            Label(t, text="All Your previous bookings will appear here ....",font=font.Font(size=10,slant="italic")).pack()
        t.mainloop()
